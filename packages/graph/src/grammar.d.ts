...
export type StartRuleNames = "MultiStatement";
export interface ParseOptions<T extends StartRuleNames = "MultiStatement"> {
  /**
...
declare function ParseFunction<Options extends ParseOptions<"MultiStatement">>(
  input: string,
  options?: Options,
): import('./AST.js').Query | import('./AST.js').UnionQuery | import('./AST.js').MultiStatement;
