...
describe("Union3 - Union in combination with Union All", () => {
  test.fails(
    "[1] Failing when mixing UNION and UNION ALL - semantic validation not implemented",
    () => {
      // Original TCK:
  ...
  test.fails(
    "[2] Failing when mixing UNION ALL and UNION - semantic validation not implemented",
    () => {
      // Original TCK:
