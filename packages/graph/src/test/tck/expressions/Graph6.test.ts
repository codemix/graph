...
describe("Graph6 - Static property access", () => {
  test.fails(
    "[1] Statically access a property of a non-null node - unlabeled nodes not supported",
    () => {
      // Original TCK:
  ...
  test.fails(
    "[2] Statically access a property of an optional non-null node - unlabeled nodes not supported",
    () => {
      // Original TCK:
      // CREATE ({existing: 42, missing: null})
  ...
  test.fails(
    "[4] Statically access a property of a node from expression - list indexing not supported",
    () => {
      // Original TCK:
  ...
  test.fails(
    "[5] Statically access a property of a non-null relationship - unlabeled nodes not supported",
    () => {
      // Original TCK:
  ...
  test.fails(
    "[6] Statically access a property of an optional non-null relationship - OPTIONAL MATCH not supported",
    () => {
      // Original TCK:
      ...
      executeTckQuery(
        graph,
        "CREATE (:A)-[:REL {existing: 42, missing: null}]->(:B)",
      );
      const results = executeTckQuery(
        graph,
  ...
  test.fails(
    "[8] Statically access a property of a relationship from expression - list indexing not supported",
    () => {
      // Original TCK:
  ...
  test.fails(
    "[9] Fail when performing property access on a non-graph element - semantic validation not implemented",
    () => {
      // Original TCK:
  ...
  test("[Custom 7] Property access with different data types", () => {
    ...
    const results = executeTckQuery(
      graph,
      "MATCH (n:A) RETURN n.str, n.num, n.flag",
    );
