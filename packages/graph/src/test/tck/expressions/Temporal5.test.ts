...
describe("Temporal5 - Access Components of Temporal Values", () => {
  ...
  test("[5] Should access weekDay from date", () => {
    ...
    const result = executeTckQuery(
      graph,
      "RETURN date('1984-10-11').dayOfWeek",
    );
    expect(result).toHaveLength(1);
  ...
  test("[7] Should access ordinalDay from date", () => {
    ...
    const result = executeTckQuery(
      graph,
      "RETURN date('1984-10-11').ordinalDay",
    );
    expect(result).toHaveLength(1);
  ...
  test("[8] Should access hour from time", () => {
    ...
    const result = executeTckQuery(
      graph,
      "RETURN time('12:31:14.645876123+01:00').hour",
    );
    expect(result).toHaveLength(1);
  ...
  test("[9] Should access minute from time", () => {
    ...
    const result = executeTckQuery(
      graph,
      "RETURN time('12:31:14.645876123+01:00').minute",
    );
    expect(result).toHaveLength(1);
  ...
  test("[10] Should access second from time", () => {
    ...
    const result = executeTckQuery(
      graph,
      "RETURN time('12:31:14.645876123+01:00').second",
    );
    expect(result).toHaveLength(1);
  ...
  test("[11] Should access millisecond from time", () => {
    ...
    const result = executeTckQuery(
      graph,
      "RETURN time('12:31:14.645876123+01:00').millisecond",
    );
    expect(result).toHaveLength(1);
  ...
  test("[12] Should access microsecond from time", () => {
    ...
    const result = executeTckQuery(
      graph,
      "RETURN time('12:31:14.645876123+01:00').microsecond",
    );
    expect(result).toHaveLength(1);
  ...
  test("[13] Should access nanosecond from time", () => {
    ...
    const result = executeTckQuery(
      graph,
      "RETURN time('12:31:14.645876123+01:00').nanosecond",
    );
    expect(result).toHaveLength(1);
  ...
  test.fails(
    "[14] Should access timezone from time - timezone property only available for named timezones",
    () => {
      ...
      const result = executeTckQuery(
        graph,
        "RETURN time('12:31:14+01:00').timezone",
      );
      expect(result).toHaveLength(1);
  ...
  test("[15] Should access offset from time", () => {
    ...
    const result = executeTckQuery(
      graph,
      "RETURN time('12:31:14+01:00').offset",
    );
    expect(result).toHaveLength(1);
  ...
  test("[16] Should access duration years component", () => {
    ...
    const result = executeTckQuery(
      graph,
      "RETURN duration('P1Y2M14DT12H31M14S').years",
    );
    expect(result).toHaveLength(1);
  ...
  test.fails(
    "[17] Should access duration months component - duration months returns total months not months-of-year",
    () => {
      ...
      const result = executeTckQuery(
        graph,
        "RETURN duration('P1Y2M14DT12H31M14S').months",
      );
      expect(result).toHaveLength(1);
  ...
  test("[18] Should access duration days component", () => {
    ...
    const result = executeTckQuery(
      graph,
      "RETURN duration('P1Y2M14DT12H31M14S').days",
    );
    expect(result).toHaveLength(1);
    expect(result[0]).toBe(14);
  });
  ...
  test("[19] Should access datetime epochSeconds", () => {
    ...
    const result = executeTckQuery(
      graph,
      "RETURN datetime('1970-01-01T00:00:00Z').epochSeconds",
    );
    expect(result).toHaveLength(1);
  ...
  test("[20] Should access datetime epochMillis", () => {
    ...
    const result = executeTckQuery(
      graph,
      "RETURN datetime('1970-01-01T00:00:00Z').epochMillis",
    );
    expect(result).toHaveLength(1);
    expect(result[0]).toBe(0);
  });
